...
class Butterfly {
	...
	constructor(id, dimension = 5) {
		...
		this.leftWing.append('path').style('fill', '#73BEFF').attr('d', 'M35.31,39.724C17.655,39.724,0,46.72,0,66.207C0,92.69,17.655,225.103,52.966,251.586 c25.463,19.097,194.207,0,194.207,0v-17.655C247.172,233.931,114.759,39.724,35.31,39.724z');
		...
		this.leftWing.append('path').style('fill', '#463246').attr('d', 'M247.172,233.931c0,0-132.414-194.207-211.862-194.207C17.655,39.724,0,46.72,0,66.207 c0,4.843,0.597,13.255,1.778,23.887C4.046,73.195,72.753,19.87,247.172,233.931z');
		...
		this.rightWing.append('path').style('fill', '#73BEFF').attr('d', 'M476.69,39.724c17.655,0,35.31,6.996,35.31,26.483c0,26.483-17.655,158.897-52.966,185.379 c-25.463,19.097-194.207,0-194.207,0v-17.655C264.828,233.931,397.241,39.724,476.69,39.724z')
		...
		this.rightWing.append('path').style('fill', '#463246').attr('d', 'M264.828,233.931c0,0,132.414-194.207,211.862-194.207c17.655,0,35.31,6.996,35.31,26.483 c0,4.843-0.597,13.255-1.778,23.887C507.954,73.195,439.247,19.87,264.828,233.931z');
